...
async function authInternal(
    ...
    if (cachedState?.authorizationServerUrl) {
        ...
        metadata =
            ...
            (await discoverAuthorizationServerMetadataInternal(authorizationServerUrl, { fetchFn, validateIssuer: false }));
        try {
    ...
    if (authorizationServerUrl === undefined) {
        throw new Error('OAuth authorization server URL was not discovered');
    }
...
export async function discoverOAuthServerInfo(
    ...
    const authorizationServerMetadata = await discoverAuthorizationServerMetadataInternal(authorizationServerUrl, {
        fetchFn: opts?.fetchFn,
        validateIssuer: authorizationServerUrlFromResourceMetadata
    });
